            ...
            <section>
              ...
              <div className="row g-3">
                ...
                <div className="col-md-6">
                  ...
                  {errors.lrn && errors.lrn.type === "max" && (
                    <div className="errorMsg">
                      Please provide the proper LRN number.
                    </div>
                  )}
                  {errors.lrn && (
                    <p className="errorMsg">{errors.lrn.message}</p>
                  )}
                </div>
              </div>
              {/* ---------------------------------------------------------------------ADDRESS SECTION-------------------------------------------------------------------------------- */}
              ...
              <div className="row g-3">
                ...
                <div className="col-md-2">
                  ...
                  />
                  {errors.zip && (
                    <p className="errorMsg">{errors.zip.message}</p>
                  )}
              ...
              <div className="form-control mt-3">
                ...
                />
                {errors.sDes && (
                  <p className="errorMsg">{errors.sDes.message}</p>
                )}
              </div>
